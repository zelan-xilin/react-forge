...
const AppUser = () => {
  ...
  return <div className="flex justify-between items-center gap-4 px-6 py-4 box-border rounded-lg bg-muted">
    <div className="flex items-center gap-2">
      <User className="size-6" />
      <div>
        <div>{user.username}</div>
        <div className="text-sm text-muted-foreground">值班中</div>
      </div>
    </div>
