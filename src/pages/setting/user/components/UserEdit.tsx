...
import { IS_ADMIN, STATUS, statusOptions } from '@/assets/enum';
    ...
    try {
      ...
      const res = data?.id
        ? await userUpdateApi({
            ...
            roleId: (formData.roleId ?? 0) > 0 ? formData.roleId : null,
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="0">暂无角色</SelectItem>
                        {roleList.map(role => (
